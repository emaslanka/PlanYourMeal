...
<form:form method="post" modelAttribute="meal" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <form:input value = "${meal.getName()}"   path="name" id="name" placeholder="np.jajecznica" class="form-control input-md"/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <form:input value = "${meal.getIngredients()}" path="ingredients" id="ingredients" placeholder="np.jajko,masło, chlebek" class="form-control input-md"/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <form:input value = "${meal.getTimeOfPrep()}" id="timeOfPrep" path="timeOfPrep" type="number" min="1"/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <form:input  value = "${meal.getLinkToRecipe()}"   path="linkToRecipe" id="linkToRecipe" placeholder="np.www.kwestiasmaku..." class="form-control input-md"/>
        ...
        <div>
            <input type="submit" name="POtwerdź">
        </div>
    </fieldset>
</form:form>
